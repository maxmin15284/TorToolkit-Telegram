try:
    ...
    class ExecVars:
        ...
        API_HASH = "102a3697e23891c7db16774dd94f5ea9"
        API_ID = 8480015
        BOT_TOKEN = "2033288495:AAEMMgqF_fizKP7gZnbOKdZGjoFD0C9rNcQ"
        BASE_URL_OF_BOT = "http://165.22.106.10"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001576449388]
        OWNER_ID = 735385079
